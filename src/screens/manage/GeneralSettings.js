...
const GeneralSettings = () => {
    ...
    const [taxInclusivePricing, toggleTaxInclusivePricing] = useState(false);
    const [enableLocalization, toggleLocalization] = useState(false);
            ...
            <div className="bg-white p-4 shadow rounded">
                ...
                <div className="mt-4">
                    ...
                    <Dropdown
                        ...
                        onOptionSelected={(option) => setTimezone(option.value)}
